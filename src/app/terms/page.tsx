      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-lg rounded-lg">
          ...
          <div className="px-6 py-8 prose prose-sm max-w-none">
            ...
            <ol>
              <li>「当社」とは、XymPay株式会社を指します。</li>
              <li>「ユーザー」とは、本サービスを利用する個人または法人を指します。</li>
              <li>「本サービス」とは、当社が提供するXymPay決済プラットフォームサービスを指します。</li>
              <li>「本規約」とは、本利用規約を指します。</li>
            </ol>
            ...
            <h2>第5条（決済サービスの利用）</h2>
            <p>
              ユーザーは、本サービスを通じて決済サービスを利用することができます。
              決済に関する手数料、利用限度額等の詳細については、別途当社が定める規定に従うものとします。
            </p>
            ...
            <p>
              ...
              当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先に通知または連絡を行い、これらは、発信時にユーザーに到達したものとみなします。
            </p>
